...
[
	...
	["Steyr AUGA2 9mm Para", "hlc_rifle_auga2para", 600]
...
//Mx
	...
	["M16A4 RIS", "rhs_weap_m16a4", 500],
	["M16A4 (Bipod)", "rhs_weap_m16a4_bipod", 550],
	["M16A4 (Grippod)", "rhs_weap_m16a4_grip", 550],
	["M16A4 (Carryhandle)", "rhs_weap_m16a4_carryhandle", 550],
	["M16A4 (Carryhandle/Pmag)", "rhs_weap_m16a4_carryhandle_pmag", 550],

	["M320 GLM", "rhs_weap_M320", 700],

	["M4 RIS", "rhs_weap_m4", 500],
	["M4 (AFG)", "rhs_weap_m4_grip2", 550],
	["M4 (Bipod)", "rhs_weap_m4_bipod", 550],
	["M4 (Grippod)", "rhs_weap_m4_grip", 550],
	["M4 (Carryhandle)", "rhs_weap_m4_carryhandle", 550],
	["M4 (Carryhandle/PMAG)", "rhs_weap_m4_carryhandle_pmag", 550],
	["M4 (M320)", "rhs_m4_m320", 700],

	["M4A1 RIS", "rhs_weap_m4a1", 500],
	["M4A1 (AFG)", "rhs_weap_m4a1_grip2", 550],
	["M4A1 (Bipod)", "rhs_weap_m4a1_bipod", 550],
	["M4A1 (Grippod)", "rhs_weap_m4a1_grip", 550],
	["M4A1 (M320)", "rhs_m4a1_m320", 700],

//AKs
	["AK-74M", "rhs_weap_ak74m", 500],
	["AK-74M (folded)", "rhs_weap_ak74m_folded", 550],
...
//FALs
	...
	["Lithgow SLR (Aussy L1A1)", "hlc_rifle_SLR", 700],
	["Steyr STG.58", "hlc_rifle_STG58F", 700],
	["FN FAL (Para)", "hlc_rifle_FAL5061", 700],
	["FN C1A1 (CAN SLR)", "hlc_rifle_c1A1", 700],
	["FN LAR (Israel)", "hlc_rifle_LAR", 700],
	["Lithgow SLR Chopmod", "hlc_rifle_SLRchopmod", 700],
	["DSA FAL OSW", "hlc_rifle_falosw", 750],
	["DSA FAL OSW M203GL", "hlc_rifle_osw_GL", 950],

//G3
	["H&K G3SG1", "hlc_rifle_g3sg1", 500],
	["H&K G3A3", "hlc_rifle_g3a3", 500],
...
//AR
	["AR15 Sanitied Carbine", "hlc_rifle_RU556", 500],
	["AR15 Magpul Carbine", "hlc_rifle_RU5562", 550],
	["Colt Carbine(727 Commando)", "hlc_rifle_Colt727", 600],
	["Colt Carbine M203(727 Commando)", "hlc_rifle_Colt727_GL", 600],
	["Bravo Company MFG/Haley", "hlc_rifle_bcmjack", 600],
...
[
	...
	["RGD-2 (white smoke)", "rhs_mag_rdg2_white", 25],
	["RGD-2 (black smoke)", "rhs_mag_rdg2_black", 25],
	...
	["Plamya-M", "rhs_mag_plamyam", 200],
	["PMN-2 AP", "rhs_mine_pmn2", 200],
	["TM-62M AT", "rhs_mine_tm62m", 300],
...
[
	...
	["5N7 AK-74 30Rnd", "rhs_30Rnd_545x39_AK", 50],
	["7T3M AK-74 30Rnd", "rhs_30Rnd_545x39_AK_green", 50],
	["7N10 AK-74 30Rnd", "rhs_30Rnd_545x39_7n10_AK", 50],
	["7N22 AK-74 30Rnd", "rhs_30Rnd_545x39_7n22_AK", 50],
	["5N7 RPK-74 45Rnd", "rhs_45Rnd_545X39_AK", 60],
	["7T3M RPK-74 45Rnd", "rhs_45Rnd_545X39_AK_Green", 60],
	["7N10 RPK-74 45Rnd", "rhs_45Rnd_545X39_7N10_AK", 60],
	["7N22 RPK-74 45Rnd", "rhs_45Rnd_545X39_7N22_AK", 60],
	["762x54mmR 100Rnd", "rhs_100Rnd_762x54mmR", 100],
	["7N1 10Rnd", "rhs_10Rnd_762x54mmR_7N1", 50],
	["M14 20Rnd", "20Rnd_762x51_Mag", 60],
	["Mk262 30Rnd", "rhs_mag_30Rnd_556x45_Mk262_Stanag", 50],
	["Mk318 30Rnd", "rhs_mag_30Rnd_556x45_Mk318_Stanag", 50],
	["M885A1 30Rnd", "rhs_mag_30Rnd_556x45_M855A1_Stanag", 50],
	["M885A1 (red) 30Rnd", "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red", 50],
	["M885A1 (green) 30Rnd", "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Green", 50],
	["M885A1 (yellow) 30Rnd", "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Yellow", 50],
	...
	["7.62x51mm Ball 100Rnd", "hlc_100Rnd_762x51_B_M60E4", 100],
	["7.62x51mm Tracer 100Rnd", "hlc_100Rnd_762x51_T_M60E4", 100],
	["7.62x51mm Mixed 100Rnd", "hlc_100Rnd_762x51_M_M60E4	", 100],
	...
	["7.62x51mm Mixed 50Rnd", "hlc_50rnd_762x51_M_FAL", 100],
	...
	[".300 Blackout 29rnd", "29rnd_300BLK_STANAG", 50],
	[".300 Blackout Tracer 29rnd", "29rnd_300BLK_STANAG_T", 50],
	[".300 Blackout FMJ 29rnd", "29rnd_300BLK_STANAG_S", 50],
	["5.56x45mm NATO EPR 30rnd", "hlc_30rnd_556x45_EPR", 50],
	["5.56x45mm NATO Mk318(SOST)30rnd", "hlc_30rnd_556x45_SOST", 60],
	["5.56x45mm NATO Mk262 30rnd", "hlc_30rnd_556x45_SPR", 60],
	["9x19mm M882 NATO Ball 30rnd", "hlc_30Rnd_9x19_B_MP5", 50],
	["9x19mm LE Hollowpoints 30rnd", "hlc_30Rnd_9x19_GD_MP5", 50],
	["9x19mm M882 subsonic 30rnd", "hlc_30Rnd_9x19_SD_MP5", 50],
	["10mm Auto FMJ 30rnd", "hlc_30Rnd_10mm_B_MP5", 50],
	["10mm Auto LE HP 30rnd", "hlc_30Rnd_10mm_JHP_MP5", 50],
	["5.56x45mm EPR 30rnd", "hlc_30Rnd_556x45_B_AUG", 50],
	["5.56x45mm Mk318 SOST 30rnd", "hlc_30Rnd_556x45_SOST_AUG", 70],
	["5.56x45mm Mk262 SPR 30rnd", "hlc_30Rnd_556x45_SPR_AUG", 70],
	["5.56x45mm Tracer 30rnd", "hlc_30Rnd_556x45_T_AUG", 50],
	["5.56x45mm EPR 40Rnd", "hlc_40Rnd_556x45_B_AUG", 50],
	["5.56x45mm Mk318 SOST 40Rnd", "hlc_40Rnd_556x45_SOST_AUG", 70],
	["5.56x45mm Mk262 SPR 40Rnd", "hlc_40Rnd_556x45_SPR_AUG", 70],
	["9x19mm M882 Ball 25Rnd", "hlc_25Rnd_9x19mm_M882_AUG", 50],
	["9x19mm LE HP 25Rnd", "hlc_25Rnd_9x19mm_JHP_AUG", 50],
	["9x19mm Subsonic 25Rnd", "hlc_25Rnd_9x19mm_subsonic_AUG", 50],
	["12g Buckshot 10rnd", "hlc_10rnd_12g_buck_S12", 50],
	["12g Slug 10rnd", "hlc_10rnd_12g_slug_S12", 50],

	["HE GP25 GP30", "hlc_VOG25_AK", 100],
	["Smoke GP25 GP30", "hlc_GRD_White", 50],
...
[
	...
	["1P29", "rhs_acc_1p29", 500, "item"],
	["1P63", "rhs_acc_1p63", 500, "item"],
	["1PN93-1 (Night vision)", "rhs_acc_1pn93_1", 500, "item"],
	["1PN93-2 (Night vision - RPG)", "rhs_acc_1pn93_2", 500, "item"],
	["EKP-1 Kobra", "rhs_acc_ekp1", 500, "item"],
	["PGO-7V (RPG optic)", "rhs_acc_pgo7v", 500, "item"],
	["PK-AS (Reflex)", "rhs_acc_pkas", 500, "item"],
	["PSO-1M2 (4x24 tele)", "rhs_acc_pso1m2", 500, "item"],
	["AN PEQ-15", "rhsusf_acc_anpeq15", 500, "item"],
	["AN PEQ-15A", "rhsusf_acc_anpeq15A", 500, "item"],
	["AN PEQ-15 M952V(Light)", "rhsusf_acc_anpeq15_light", 500, "item"],
	["EOtech XPS3", "rhsusf_acc_EOTECH", 500, "item"],
	["Leupold Mk4 (3.5-10x40mm)", "rhsusf_acc_LEUPOLDMK4", 500, "item"],
	["Leupold Mk4 (6.5-20x50mm)", "rhsusf_acc_LEUPOLDMK4_2", 500, "item"],
	["M145 MGO Elcan", "rhsusf_acc_ELCAN", 500, "item"],
	["M150 RCO ACOG", "rhsusf_acc_ACOG", 500, "item"],
	["M150 RCO ACOG (ARD)	", "rhsusf_acc_ACOG2", 500, "item"],
	["M150 RCO ACOG (ARD/Lens Cover)", "rhsusf_acc_ACOG3", 500, "item"],
	...
	["AN/PVS4 Night Optic(FALs)", "hlc_optic_PVS4FAL", 500, "item"],
	["SUIT Optic (Trilux FALs)", "hlc_optic_suit", 500, "item"],
	["Zeiss Diavari 6x Optic", "HLC_Optic_ZFSG1", 500, "item"],
	["Accupoint TR20(G3)optic", "hlc_optic_accupoint_g3", 500, "item"],
	["Redfield AR-TEL Optic(3-9x)", "hlc_optic_artel_m14", 500, "item"],
	["Leupold LR/T (LRPS)", "hlc_optic_LRT_m14", 1500, "item"],
...
//AFRF
	...
	["BMD-1 Combat", "rhs_bmd1", 10000, "vehicle"],
	["BMD-1k Command", "rhs_bmd1k", 10000, "vehicle"],
	["BMD-1p Combat", "rhs_bmd1p", 10000, "vehicle"],
	["BMD-1pk Command", "rhs_bmd1pk", 10000, "vehicle"],
	["BMD-1R Rocket", "rhs_bmd1r", 10000, "vehicle"],
	["BMD-2", "rhs_bmd2", 10000, "vehicle"],
	["BMD-2K Command", "rhs_bmd2k", 10000, "vehicle"],
	["BMD-2M Modern", "rhs_bmd2m", 10000, "vehicle"],
	["BDM-4", "rhs_bmd4_vdv", 10000, "vehicle"],
	["BDM-4M", "rhs_bmd4m_vdv", 10000, "vehicle"],
	["BDM-4M(A)", "rhs_bmd4ma_vdv", 10000, "vehicle"],
	["BMP-1", "rhs_bmp1_XX", 10000, "vehicle"],
	["BMP-1P Improved", "rhs_bmp1p_XX", 10000, "vehicle"],
	["BMP-1K Command", "rhs_bmp1k_XX", 10000, "vehicle"],
	["BMP-1D UpArmoured", "", 10000, "vehicle"],
	["BMP-2 (E)	 Export", "rhs_bmp2e_XX", 10000, "vehicle"],
	["BMP-2", "rhs_bmp2_XX", 10000, "vehicle"],
	["BMP-2K Command", "rhs_bmp2k_XX", 10000, "vehicle"],
	["BMP-2D UpArmoured", "rhs_bmp2d_XX", 10000, "vehicle"],
	...
	["BRM-1K MSV", "rhs_brm1k_msv", 10000, "vehicle"],
	["BRM-1K TV", "rhs_brm1k_tv", 10000, "vehicle"],
	["BRM-1K VDV", "rhs_brm1k_vdv", 10000, "vehicle"],
	["BRM-1K VV", "rhs_brm1k_vv", 10000, "vehicle"],
	["BTR-60 APC MSV", "rhs_btr60_msv", 10000, "vehicle"],
	["BTR-60 APC VDV", "rhs_btr60_vdv", 10000, "vehicle"],
	["BTR-60 APC VMF", "rhs_btr60_vmf", 10000, "vehicle"],
	["BTR-60 APC VV", "rhs_btr60_vv", 10000, "vehicle"],
	["BTR-70 APC MSV", "rhs_btr70_msv", 10000, "vehicle"],
	["BTR-70 APC VDV", "rhs_btr70_vdv", 10000, "vehicle"],
	["BTR-70 APC VMF", "rhs_btr70_vmf", 10000, "vehicle"],
	["BTR-70 APC VV", "rhs_btr70_vv", 10000, "vehicle"],
	["BTR-80 APC MSV", "rhs_btr80_msv", 10000, "vehicle"],
	["BTR-80 APC VDV", "rhs_btr80_vdv", 10000, "vehicle"],
	["BTR-80 APC VMF", "rhs_btr80_vmf", 10000, "vehicle"],
	["BTR-80 APC VV", "rhs_btr80_vv", 10000, "vehicle"],
	["BTR-80A APC MSV", "rhs_btr80a_msv", 10000, "vehicle"],
	["BTR-80A APC VDV", "rhs_btr80a_vdv", 10000, "vehicle"],
	["BTR-80A APC VMF", "rhs_btr80a_vmf", 10000, "vehicle"],
	["BTR-80A APC VV", "rhs_btr80a_vv", 10000, "vehicle"],
	["GAZ-233011 Tigr MSV", "rhs_tigr_msv", 10000, "vehicle"],
	["GAZ-233011 Tigr VDV", "rhs_tigr_vdv", 10000, "vehicle"],
	["GAZ-233011 Tigr VMF", "rhs_tigr_vmf", 10000, "vehicle"],
	["GAZ-233011 Tigr VV", "rhs_tigr_vv", 10000, "vehicle"],
	["GAZ-66 MSV", "rhs_gaz66_msv", 10000, "vehicle"],
	["GAZ-66 VDV", "rhs_gaz66_vdv", 10000, "vehicle"],
	["GAZ-66 VMF", "rhs_gaz66_vmf", 10000, "vehicle"],
	["GAZ-66 VV", "rhs_gaz66_vv", 10000, "vehicle"],
	["GAZ-66 (Open) MSV", "rhs_gaz66o_msv", 10000, "vehicle"],
	["GAZ-66 (Open) VDV", "rhs_gaz66o_vdv", 10000, "vehicle"],
	["GAZ-66 (Open) VMF", "rhs_gaz66o_vmf", 10000, "vehicle"],
	["GAZ-66 (Open) VV", "rhs_gaz66o_vv", 10000, "vehicle"],
	["GAZ-66 (R-142N) MSV", "rhs_gaz66_r142_msv", 10000, "vehicle"],
	["GAZ-66 (R-142N) VDV", "rhs_gaz66_r142_vdv", 10000, "vehicle"],
	["GAZ-66 (R-142N) VMF", "rhs_gaz66_r142_vmf", 10000, "vehicle"],
	["GAZ-66 (R-142N) VV", "rhs_gaz66_r142_vv", 10000, "vehicle"],
	["GAZ-66 (AP-2) MSV", "rhs_gaz66_ap2_msv", 10000, "vehicle"],
	["GAZ-66 (AP-2) VDV", "rhs_gaz66_ap2_vdv", 10000, "vehicle"],
	["GAZ-66 (AP-2) VMF", "rhs_gaz66_ap2_vmf", 10000, "vehicle"],
	["GAZ-66 (AP-2) VV", "rhs_gaz66_ap2_vv", 10000, "vehicle"],
	["GAZ-66 (ESB-8IM) MSV", "rhs_gaz66_repair_msv", 10000, "vehicle"],
	["GAZ-66 (ESB-8IM) VDV", "rhs_gaz66_repair_vdv", 10000, "vehicle"],
	["GAZ-66 (ESB-8IM) VMF", "rhs_gaz66_repair_vmf", 10000, "vehicle"],
	["GAZ-66 (ESB-8IM) VV", "rhs_gaz66_repair_vv", 10000, "vehicle"],
	["PRP-3 MSV", "rhs_prp3_msv", 10000, "vehicle"],
...
//AFRF
	...
	["Ka-60 Camo", "rhs_ka60_c", 10000, "vehicle"],

	["Mi-24P VDV", "RHS_Mi24P_vdv", 60000, "vehicle"],
	["Mi-24V VDV", "RHS_Mi24V_vdv", 60000, "vehicle"],
	["Mi-24P Grey", "RHS_Mi24P_vvs", 60000, "vehicle"],
	["Mi-24V Grey", "RHS_Mi24V_vvs", 60000, "vehicle"],
	["Mi-24P Camo", "RHS_Mi24P_vvsc", 60000, "vehicle"],
	["Mi-24V Camo", "RHS_Mi24V_vvsc", 60000, "vehicle"],

	["Mi-8AMT VDV", "RHS_Mi8AMT_vdv", 50000, "vehicle"],
	["Mi-8AMT Grey", "RHS_Mi8AMT_vvs", 50000, "vehicle"],
	["Mi-8AMT Camo", "RHS_Mi8AMT_vvsc", 50000, "vehicle"],
	["Mi-8AMTSh VDV", "RHS_Mi8AMTSh_vdv", 50000, "vehicle"],
	["Mi-8AMTSh Grey", "RHS_Mi8AMTSh_vvs", 50000, "vehicle"],
	["Mi-8AMTSh Camo", "RHS_Mi8AMTSh_vvsc", 50000, "vehicle"],

	["Mi-8MT VDV", "RHS_Mi8mt_vdv", 50000, "vehicle"],
	["Mi-8MT VV", "RHS_Mi8mt_vv", 50000, "vehicle"],
	["Mi-8MT Grey", "RHS_Mi8mt_vvs", 50000, "vehicle"],
	["Mi-8MT Camo", "RHS_Mi8mt_vvsc", 50000, "vehicle"],
	["Mi-8MTV-3 VDV", "RHS_Mi8MTV3_vdv", 50000, "vehicle"],
	["Mi-8MTV-3 Grey", "RHS_Mi8MTV3_vvs", 50000, "vehicle"],
	["Mi-8MTV-3 Camo", "RHS_Mi8MTV3_vvsc", 50000, "vehicle"],


//USAF
	["AH-64D Apache Wood", "rhs_ah64d_wd", 65000, "vehicle"],
	["AH-64D Apache Desert", "rhs_ah64d", 65000, "vehicle"],
	["CH-47 Chinook Wood", "rhs_ch_47f", 30000, "vehicle"],
	["CH-47 Chinook Desert", "rhs_ch_47f_light", 30000, "vehicle"],

	["UH-60M Woodland", "rhs_uh60m", 30000, "vehicle"],
	["UH-60M Desert", "rhs_uh60m_d", 30000, "vehicle"],
	["UH-60M MEV Woodland", "rhs_uh60m_mev", 30000, "vehicle"],
	["UH-60M MEV Desert", "rhs_uh60m_mev_d", 30000, "vehicle"]
