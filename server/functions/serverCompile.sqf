...
createRandomGroup = [_path, "createUnits\createRandomGroup.sqf"] call mf_compile;
...
randomAltMuzzleMags = [_path, "randomAltMuzzleMags.sqf"] call mf_compile;
...
addRandomCargoItems = [_path, "addRandomCargoItems.sqf"] call mf_compile;
